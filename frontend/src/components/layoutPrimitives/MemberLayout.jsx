 ...
 * @param {String} activePage - Tên trang hiện tại để highlight button
 */
const MemberLayout = ({ children, rightButtons, activePage }) => {
  return (
    <div className="flex flex-col md:flex-row h-full w-full">
      ...
      <div className="w-full md:w-64 py-4 px-3 bg-blue-50 flex flex-col gap-2.5">
