...
const LocationPreference = () => {
  ...
  const rightButtons = [
    ...
    { label: 'Quản lý thời gian', onClick: handleEditTime },
    { label: 'Quản lý vị trí và sở thích', onClick: handleEditLocation },
    { label: 'Lịch rảnh nhóm', onClick: handleViewGroupCalendar },
  ];
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      {/* Main Content */}
      <MemberLayout rightButtons={rightButtons} activePage="Quản lý vị trí và sở thích">
