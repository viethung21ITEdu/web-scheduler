...
--thêm user vào hàng đợi nhóm
insert into group_join_requests (group_id, user_id, invite_id, status, message, created_at, processed_at, processed_by)
values (44, 36, null, 'pending', null, now(), null, null);
